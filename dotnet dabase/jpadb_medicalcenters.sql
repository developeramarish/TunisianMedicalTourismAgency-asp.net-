...
CREATE TABLE `medicalcenters` (
  `ID_Med_center` int(11) NOT NULL,
  `adress_Med_center` varchar(255) DEFAULT NULL,
  `conventionne` varchar(255) DEFAULT NULL,
  `name_Med_center` varchar(255) DEFAULT NULL,
  `resp_Med_center` varchar(255) DEFAULT NULL,
  `speciality_Med_center` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ID_Med_center`)
